...
Build Web2API — a platform that turns any website into a REST API by scraping target sites live using Playwright. Recipes are self-contained folders with declarative YAML config. Drop a folder = new API endpoint.
